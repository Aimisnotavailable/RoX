...
class ARController:
    def __init__(self, engine):
        ...
        self.gesture_manager.add_detector(OpenPalmDetector('RIGHT', hold_frames=15))
        ...
        self.radial_menu_type = None   # 'blocks' or 'worldgen'
        ...
        # last block pointed at by right hand (for block info)
    ...
    # Radial menu helpers
    # ------------------------------------------------------------------
    def open_radial_menu(self, hand_pos, menu):
        if hand_pos is None:
            return
        ...
        self.engine.scene.hud.radial_menu.activate(self.radial_menu_center, menu)
        get_logger_info('AR', f'Radial menu ({self.radial_menu_type}) at ({screen_x:.0f}, {screen_y:.0f})')
